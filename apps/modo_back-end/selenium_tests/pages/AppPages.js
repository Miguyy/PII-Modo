...
class DashboardPage {
    ...
    async completeTaskAndGetPoints(taskId) {
        ...
        await this.driver.wait(until.elementTextMatches(pointsElement, /^[1-9]\d*$/), 10000);
    }
...
class SettingsPage {
    ...
    async equipAvatarDecoration(decorationId) {
        ...
        const applyBtn = await this.driver.findElement(By.id("btn-apply-decoration"));
        await applyBtn.click();
    }
}

module.exports = { DashboardPage, SettingsPage /* and ExplorePage */ };