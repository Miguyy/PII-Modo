...
tipo_utilizador (enum (admin, normal), default normal)
*/
...
export default (sequelize, DataTypes) => sequelize.define("user", {
    ...
    pontos: { type: DataTypes.INTEGER, defaultValue: 0, validate: { isInt: true, min: 0 } },
    data_criacao_conta: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
    tipo_utilizador: { type: DataTypes.ENUM("admin", "normal"), defaultValue: "normal" }
}, {
