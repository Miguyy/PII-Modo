...
tipo_impacto (enum (water, electric), not null),
...
export default (sequelize, DataTypes) => sequelize.define("impact", {
    ...
    tipo_impacto: { type: DataTypes.ENUM("water", "electric"), allowNull: false },
    valor_por_unidade: {
