...
import ImpactModel from "./impacts.model.js";
const Impact = ImpactModel(sequelize,DataTypes);

import AvatarDecorationModel from "./avatarDecoration.model.js";
const AvatarDecoration = AvatarDecorationModel(sequelize,DataTypes);

import UserTasksModel from "./userTasks.model.js";
const UserTasks = UserTasksModel(sequelize,DataTypes);

import ActiveAvatarDecorationModel from "./activeAvatarDecoration.model.js";
const ActiveAvatarDecoration = ActiveAvatarDecorationModel(sequelize,DataTypes);
