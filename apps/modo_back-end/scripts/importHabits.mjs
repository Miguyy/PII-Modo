/*
  Purpose: This script is responsible for importing habit data from a JSON file into the database.
  It reads the data from the specified JSON file, processes it, and then uses Sequelize's bulkCreate method to insert the data into the Habit table in chunks.
